...
{
    app = PIXI.autoDetectRenderer(window.innerWidth, window.innerHeight, {
            autoResize: true,
...
// create a background...
    var background = PIXI.Sprite.fromImage('images/button.jpg');
...
// create some textures from an image path
    ...
    var textureButtonOver = PIXI.Texture.fromImage('images/button.png');
